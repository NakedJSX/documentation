import { Topic, Inline } from "$SRC/common.jsx";
...
export default
    ...
    <Topic name="CSS" path="css">
        <p>
            NakedJSX is CSS aware, and injects an inline <Inline lang="jsx">{'<style>'}</Inline> tag
            in the document head that contains classes generated by NakedJSX features.
        </p>
...
Page.Render();`
        ...
        <Topic name="Common CSS File" path="common">
            ...
            <Example buildFlags={['--css-common', 'src/style.css', '--pretty']} captureOutput={['example', 'css', 'common']}>
